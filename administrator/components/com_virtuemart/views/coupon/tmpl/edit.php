 ...
 * @version $Id: edit.php 9041 2015-11-05 11:59:38Z Milbo $
 */
...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	...
	<fieldset>
		...
		echo VmHTML::row('input','COM_VIRTUEMART_VALUE','coupon_value',$this->coupon->coupon_value,'class="required"','',10,32);
		...
		echo VmHTML::row('input','COM_VIRTUEMART_COUPON_VALUE_VALID_AT','coupon_value_valid', $this->coupon->coupon_value_valid, 'class="form-control"','',10,255,' ' . $this->vendor_currency ); 
